...
export default function Card({id, title, views, im, award, video}:ICard) {
      ...
      <div className="card__wrap">
        <div className="card__inner">
          <div className="video" onMouseEnter={() => playPause(true)}  onMouseLeave={() => playPause(false)}>
            ...
            <video id={id} className="video__img" poster={im} playsInline muted autoPlay={false} loop preload="auto"> 
